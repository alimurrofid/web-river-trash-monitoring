 ...
 */
export const getActiveStreamingLinks = async (req, res) => {
    try {
 ...
 */
export const getActiveStreamingLinkByBillboard = async (req, res) => {
    try {
 ...
 */
export const updateStreamingLink = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        if (expired_at)
            updateData.expired_at = new Date(expired_at);
        if (billboard_name)
            updateData.billboard_name = billboard_name;
 ...
 */
export const deleteStreamingLink = async (req, res) => {
    try {
        const { id } = req.params;
        // Validasi ID
        if (!id || isNaN(parseInt(id))) {
 ...
 */
export const validateStreamingLink = async (req, res) => {
    try {
